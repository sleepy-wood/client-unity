...
public class TransparencyCapture
{
    ...
    /// </summary>
    /// <returns> 캡쳐한 스크린샷의 Texture2D </returns>
    ...
    /// eg. TransparencyCapture.captureScreenshot("Screenshot.png")
    /// </summary>
    /// <param name="pFileName"> 저장할 파일 이름 </param>
    /// <returns></returns>
    ...
    //calculate the alpha value in every pixel, with the two captures.
