...
namespace Broccoli.Utils
{
    ...
    {
        public static void BakeAO (MeshCollider collider, ref Color[] colors, Vector3[] verts, Vector3[] normals, int[] branchTri, int[] leafTri, GameObject ob, int samples, float distance, float strength = 1f) {
