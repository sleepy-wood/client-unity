...
namespace Broccoli.NodeEditorFramework.Utilities 
{
	...
	public static class GUIScaleUtility
	{
		...
		public static Rect getTopRect { 
			get { 
				if (GetTopRectDelegate != null)
					return (Rect)GetTopRectDelegate.Invoke (); 
				return Rect.zero;
			} 
		}
		...
		public static void Init () 
		{
			...
			PropertyInfo topmostRect = GUIClipType.GetProperty ("topmostRect", BindingFlags.Static | BindingFlags.NonPublic);
			#else
