    ...
    public static class CutMeshWithPlane 
    {
        ...
        public static List<Mesh> CutMesh(Transform meshTrans, OrientedPlane3 orientedCutPlaneGlobal)
        {
            ...
            for (int i = 0; i < triangles.Length; i += 3)
            {
                ...
                MyVector3 p1 = MyVector3.ToMyVector3(p1_unity);
                MyVector3 p2 = MyVector3.ToMyVector3(p2_unity);
                MyVector3 p3 = MyVector3.ToMyVector3(p3_unity);

                //Normals
                MyVector3 n1 = MyVector3.ToMyVector3(normals[triangleIndex1]);
                MyVector3 n2 = MyVector3.ToMyVector3(normals[triangleIndex2]);
                MyVector3 n3 = MyVector3.ToMyVector3(normals[triangleIndex3]);
        ...
        private static HashSet<HalfEdgeData3> SeparateMeshIslands(HalfEdgeData3 meshData)
        {
            ...
            HalfEdgeFace3 firstFace = allFaces.FakePopHCGL();
            ...
            while (true)
            {
                ...
                if (facesToFloodFrom.Count == 0)
                {
                    ...
                    if (allFaces.Count > 0)
                    {
                        ...
                        //Add a first face to the queue
                        firstFace = allFaces.FakePopHCGL();
        ...
        private static HashSet<Hole> FillHoles(HashSet<HalfEdge3> holeEdgesI, HashSet<HalfEdge3> holeEdgesO, OrientedPlane3 orientedCutPlane, Transform meshTrans, MyVector3 planeNormal)
        {
            ...
            //    {
            //        Debug.DrawLine(meshTrans.TransformPoint(MyVector3.ToVector3(e.v.position)), Vector3.zero, Color.white, 5f);
            //    }
            //}
            ...
            foreach (List<HalfEdge3> hole in allHoles)
            {
                ...
                foreach (HalfEdge3 e in hole)
                {
                    ...
                    Vector3 pGlobalSpace = meshTrans.TransformPoint(MyVector3.ToVector3(pMeshSpace));
                ...
                foreach (Triangle2 t in triangles)
                {
                    ...
                    //For inside mesh
                    MyMeshVertex v1_I = new MyMeshVertex(MyVector3.ToMyVector3(p1Mesh), planeNormal);
                    MyMeshVertex v2_I = new MyMeshVertex(MyVector3.ToMyVector3(p2Mesh), planeNormal);
                    MyMeshVertex v3_I = new MyMeshVertex(MyVector3.ToMyVector3(p3Mesh), planeNormal);

                    //For inside mesh
                    MyMeshVertex v1_O = new MyMeshVertex(MyVector3.ToMyVector3(p1Mesh), -planeNormal);
                    MyMeshVertex v2_O = new MyMeshVertex(MyVector3.ToMyVector3(p2Mesh), -planeNormal);
                    MyMeshVertex v3_O = new MyMeshVertex(MyVector3.ToMyVector3(p3Mesh), -planeNormal);
        ...
        private static HashSet<List<HalfEdge3>> IdentifySeparateHoles(HashSet<HalfEdge3> cutEdges)
        {
            ...
            HalfEdge3 startEdge = cutEdges.FakePopHCGL();
            ...
            while (true)
            {
                ...
                else if (nextEdge == startEdge)
                {
                    ...
                    if (cutEdges.Count > 0)
                    {
                        startEdge = cutEdges.FakePopHCGL();
        ...
        private static void CutTriangleOneOutside(MyMeshVertex O1, MyMeshVertex I1, MyMeshVertex I2, HalfEdgeData3 newMeshO, HalfEdgeData3 newMeshI, HashSet<HalfEdge3> newEdgesI, HashSet<HalfEdge3> newEdgesO, Plane3 cutPlane)
        {
            ...
            //MyVector3 normal_F1B1 = Vector3.Slerp(MyVector3.ToVector3(F1.normal), MyVector3.ToVector3(B1.normal), percentageBetween_F1B1).ToMyVector3();
            //MyVector3 normal_B2F1 = Vector3.Slerp(MyVector3.ToVector3(B2.normal), MyVector3.ToVector3(F1.normal), percentageBetween_B2F1).ToMyVector3();
        ...
        private static void CutTriangleTwoOutside(MyMeshVertex O1, MyMeshVertex O2, MyMeshVertex I1, HalfEdgeData3 newMeshO, HalfEdgeData3 newMeshI, HashSet<HalfEdge3> newEdgesI, HashSet<HalfEdge3> newEdgesO, Plane3 cutPlane)
        {
            ...
            //MyVector3 normal_F2B1 = Vector3.Slerp(MyVector3.ToVector3(F2.normal), MyVector3.ToVector3(B1.normal), percentageBetween_F2B1).ToMyVector3();
            //MyVector3 normal_B1F1 = Vector3.Slerp(MyVector3.ToVector3(B1.normal), MyVector3.ToVector3(F1.normal), percentageBetween_B1F1).ToMyVector3();
