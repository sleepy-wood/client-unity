...
namespace Broccoli.Clipper2Lib
{
  ...
  internal class Vertex
  {
    ...
    public Vertex(Point64 pt, VertexFlags flags, Vertex prev = null)
    {
      this.pt = pt;
      this.flags = flags;
      next = null;
  ...
  {
    public int idx;
    public OutRec owner = null;
    public List<OutRec> splits = null;
    public Active frontEdge = null;
    public Active backEdge = null;
    public OutPt pts = null;
    public PolyPathBase polypath = null;
  ...
  internal class Joiner
  {
    public int idx;
    public OutPt op1;
    public OutPt op2 = null;
    public Joiner next1 = null;
    public Joiner next2 = null;
    public Joiner nextH = null;

    public Joiner(List<Joiner> joinerList, OutPt op1, OutPt op2 = null, Joiner nextH = null)
    {
      if (joinerList != null)
      {
  ...
  internal class Active
  {
    ...
    public OutRec outrec = null;

    // AEL: 'active edge list' (Vatti's AET - active edge table)
    //     a linked list of all edges (from left to right) that are present
    //     (or 'active') within the current scanbeam (a horizontal 'beam' that
    //     sweeps from bottom to top over the paths in the clipping operation).
    public Active prevInAEL = null;
    public Active nextInAEL = null;

    // SEL: 'sorted edge list' (Vatti's ST - sorted table)
    //     linked list used when sorting edges into their new positions at the
    //     top of scanbeams, but also (re)used to process horizontals.
    public Active prevInSEL = null;
    public Active nextInSEL = null;
    public Active jump = null;
    public Vertex vertexTop = null;
  ...
  public class ClipperBase
  {
    ...
    *******************************************************************************/
    ...
    private bool IsContributingClosed(Active ae)
    {
      ...
      switch (_cliptype)
      {
        ...
        /*
          ...
          */
          if (_fillrule == FillRule.Positive) return ae.windCount2 > 0;
          else if (_fillrule == FillRule.Negative) return ae.windCount2 < 0;
          else return ae.windCount2 != 0;
        ...
        /*
          ...
          */
          bool result = false;
          if (_fillrule == FillRule.Positive) result = (ae.windCount2 <= 0);
          else if (_fillrule == FillRule.Negative) result = (ae.windCount2 >= 0);
          else result = (ae.windCount2 == 0);
    ...
    private bool IsContributingOpen(Active ae)
    {
      ...
      */
      if (_cliptype == ClipType.Intersection) result = isInClip;
      else if (_cliptype == ClipType.Union) result = !isInSubj && !isInClip;
      else result = !isInClip;
      return result;
    }
