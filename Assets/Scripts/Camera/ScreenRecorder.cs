...
public class ScreenRecorder : MonoBehaviour
{
    ...
    public void EncodeAndSave()
    {
        ...
        print("1");
        string to = $"{Application.persistentDataPath}/Zipfiles/TreeImgZip_{GameManager.Instance.treeController.treeId}.zip";
        if (!System.IO.Directory.Exists($"{Application.persistentDataPath}/Zipfiles"))
        {
            System.IO.Directory.CreateDirectory($"{Application.persistentDataPath}/Zipfiles");
            print("1-1");
        }
        ...
        byte[] data = File.ReadAllBytes(to);
        print("Zip length : " + data.Length);
        print("이미지 압축 완료");
...
#elif UNITY_IOS || UNITY_ANDROID
        string path = $"{Application.persistentDataPath}/Zipfiles/TreeImgZip_{GameManager.Instance.treeController.treeId}.zip";
#endif
